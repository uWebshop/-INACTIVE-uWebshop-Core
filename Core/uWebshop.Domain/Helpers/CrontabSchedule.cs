...
namespace uWebshop.Domain.Helpers.CrontabSchedule
{
	// the contents of this file originate from https://code.google.com/p/ncrontab/ literal copy of version 1.0 (only non-functional changes applied)
	//   they fall under the Apache License 2.0 http://www.apache.org/licenses/LICENSE-2.0 and are copyright of their original owner https://code.google.com/u/azizatif/
	//   in-sourced because uWebshop currently cannot depend on libraries or nuget packages

	#region License, Terms and Author(s) for this file only
	//
